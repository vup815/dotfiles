...
local java_home = "/Library/Java/JavaVirtualMachines/openjdk.jdk/Contents/Home/bin/java"
    ...
    java = {
      ...
      configuration = {
        ...
        runtimes = {
          {
            name = "JavaSE-18",
            path = "/Users/samtseng/Library/Java/JavaVirtualMachines/corretto-18.0.2/Contents/Home",
          }
        }
      },
      maven = {
      ...
      format = {
        enabled = true,
        settings = {
          url = vim.fn.stdpath "config" .. "/after/intellij-java-google-style.xml",
          profile = "GoogleStyle",
        },
      },
